...
public final class ControllerResponses {
  public static <T> String jsonResponse(@NotNull Either<EitherError, T> eitherErrorOrEntity, @NotNull Function<EitherError, String> failureResponse, @NotNull Function<String, String> successResponse) {
