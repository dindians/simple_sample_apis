...
import org.example.simple_sample_apis.usecase_factories.HttpResponseError;
import org.example.simple_sample_apis.usecase_factories.HttpResponseNotOk;
import org.example.simple_sample_apis.usecase_factories.UsecaseFactoryMethods;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

class UsecaseFactoryMethodsTest {
  @Test
  void getBodyForHttpResponseSuccessOk() {
    ...
    final var eitherErrorOrBody = UsecaseFactoryMethods.getBody(expectedHttpResponseSuccessOk);
    assertAll(
  ...
  void getBodyForHttpResponseSuccessNotOk() {
    ...
    final var eitherErrorOrBody = UsecaseFactoryMethods.getBody(expectedHttpResponseSuccessNotOk);
    assertAll(
  ...
  void getBodyForHttpResponseFailure() {
    ...
    final var eitherErrorOrBody = UsecaseFactoryMethods.getBody(expectedHttpResponseFailure);
    assertAll(
      () -> assertNotNull(eitherErrorOrBody),
      () -> assertTrue(eitherErrorOrBody instanceof Either.Left)
    );
